...
DROP POLICY IF EXISTS "Only master admins can manage roles" ON public.user_roles;
...
DROP POLICY IF EXISTS "Users and master admins can view favorite locations" ON public.favorite_locations;
DROP POLICY IF EXISTS "Users and master admins can delete favorite locations" ON public.favorite_locations;
